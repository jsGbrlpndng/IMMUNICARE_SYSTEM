...
const ClinicalDeleteWarningModal = ({ data, onDeactivate, onClose, submitting }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-[2px] z-50 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-lg border border-slate-300 shadow-2xl overflow-hidden">
                ...
                <div className="space-y-4 px-6 py-5">
                    ...
                    <p className="text-xs font-semibold text-slate-500">
                        Deactivation blocks future login while preserving the staff attribution on infant records, vaccination logs, and follow-up history.
                    </p>
                </div>
                <div className="flex gap-3 border-t border-slate-200 px-6 py-4">
                    <button
                        ...
                        disabled={submitting || data.user?.is_active === false}
                        className="flex-1 bg-[#064E3B] px-4 py-2.5 text-xs font-black uppercase tracking-[0.12em] text-white hover:bg-[#043828] disabled:cursor-not-allowed disabled:bg-slate-300"
                    >
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="flex-1 border border-slate-300 px-4 py-2.5 text-xs font-black uppercase tracking-[0.12em] text-slate-700 hover:border-slate-500"
                    >
                        Cancel
                    </button>
                </div>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-1">
                                            ...
                                            <button
                                                ...
                                                className="p-2 rounded-lg text-slate-400 transition-colors hover:bg-red-50 hover:text-red-700"
                                                title="Delete User"
                                            >
