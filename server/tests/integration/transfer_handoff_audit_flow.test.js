...
const validPayload = () => ({
    ...
    caregiver_contact: '09171234567',
    pregnancy_order: 2,
    mother_tt_status: '2',
    last_tt_date: '2025-12-01',
    birth_weight: 3.1,
    length_at_birth_cm: 49,
    birth_setting: 'Facility',
    delivery_facility_name: 'San Pedro Health Center',
    birth_facility_name: 'San Pedro Health Center',
